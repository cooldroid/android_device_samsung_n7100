...
PHILZ_ZIP_FILE      := $(PHILZ_OUT_PATH)/philz_touch_$(PHILZ_BUILD)_$(PHILZ_DEVICE_NAME).zip
...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) \
	...
	$(hide) cp $@ /media/sf_D/android/recovery_$(PHILZ_BUILD).img
	$(hide) $(call assert-max-image-size,$@,$(BOARD_RECOVERYIMAGE_PARTITION_SIZE),raw)
	@echo Making Philz Touch Recovery Zip...
	...
	$(PHILZ_BUILD)_$(PHILZ_DEVICE_NAME) $@
